...
m1<-satract%>%
  ...
  guides(fill=guide_legend(title="Percent Developed"))+
  ggtitle(label="Percent of Land Area Developed, 2006", subtitle ="NLCD 2006")+
  theme(axis.text.x = element_blank(), axis.text.y = element_blank())+
  theme( legend.text = element_text(size = 14), plot.title = element_text(size = 18), strip.text.x = element_text(size = 16))
...
### Normalized Density Vegitation Index - NDVI
