...
```{r, results='hide'}
age.tract<-get_acs(geography = "tract",state="48", county="029", year =2015, variable = c("B01001_003", "B01001_027", "B19083_001"), output="wide", geometry = T)
...
```{r}
library(spdep)
test<-poly2nb(as(age.tract, "Spatial"))
st_queen <- function(a, b = a) st_relate(a, b, pattern = "F***T****")
st_rook <- function(a, b = a) st_relate(a, b, pattern = "F***1****")
nbq<-st_queen(age.tract[is.na(age.tract$B19083_001E)==F,])
class(nbq)<-c("sgbp", "nb")
mat<-nb2listw(nbq, style = "W")

moran.mc(age.tract$B19083_001E[is.na(age.tract$B19083_001E)==F,], listw = mat, nsim = 99, na.action = "na.omit")
```
