...
nlcd<-raster("/media/corey/0E45-D54F/classes/dem7093/dem7093_20/data/bexar_nlcddata.tif")
...
```{r,eval=FALSE}
library(sf)
bexarco<-st_read("/media/corey/extra/gis_classwork/bexarpolygon.shp")
bexarco<-st_transform(bexarco, crs=crs(nlcd))
bexarco<- as_Spatial(bexarco)
# doesn't work
#est<-raster::extract(x=nlcd,y=ext)
```
